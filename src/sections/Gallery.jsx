    ...
    <section className="py-16 bg-gray-50 w-full">
      <div className="container mx-auto px-4 ">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4 font-[curvyText]">Our Gallery</h2>
          <div className="w-24 h-1 bg-[#50653e] mx-auto"></div>
        </div>
        ...
        <div className="relative w-full">
          ...
          <div className='absolute w-full h-full top-0 left-0 z-10 pointer-events-none'>
             <div className={`w-15 h-15 rounded-full bg-emerald-950 absolute top-1/2 z-20 -translate-y-1/2 -translate-x-1/2
               ${isHover?"opacity-100":"opacity-50"} transition-all duration-500 ease-in-out flex justify-center items-center cursor-pointer pointer-events-auto`}
            onClick={() => {
              if (swiperInstance) {
                swiperInstance.slidePrev()
              }
            }} 
            onMouseEnter={hoverAni} onMouseLeave={hoverAni}
             >
             <FontAwesomeIcon icon={faChevronLeft} className="text-white text-2xl"/>
             </div>

             {/* right icon */}
            <div className={`w-15 h-15 rounded-full bg-emerald-950 absolute top-1/2 z-20 right-0 -translate-y-1/2 translate-x-1/2  flex justify-center items-center cursor-pointer pointer-events-auto ${isHover?"opacity-100":"opacity-50"} transition-all duration-500 ease-in-out`}
            onClick={() => {
              if (swiperInstance) {
