...
const CeoSection = () => {
  return (
    <section className="w-full min-h-screen lg:h-auto bg-emerald-950 p-10 flex  flex-col lg:flex-row lg:gap-8">
      ...
      <section className="rightCeoSec  flex flex-col flex-1 font-[curvyText] gap-6  items-center p-2 !text-white ">
        <h2 className="self-start text-lg lg:text-3xl ">
          A <span className="italic ">message</span> from  Our CEO
        </h2>
        <hr className="w-full h-px bg-[#50653e]" />
        <h2 className=" self-start text-2xl  -mb-4 text-white" >Mission</h2>
        ...
        <h2 className=" self-start text-2xl  -mb-4 text-white" >Vision</h2>
        <h3 className=" text-lg">
        ...
        <h2 className=" self-start text-2xl  -mb-4 text-white" >Message</h2>
