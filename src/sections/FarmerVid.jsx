...
const FarmerVid = () => {
  return (
    <div className='w-full h-screen overflow-hidden relative'>
        <video  className='w-full h-auto object-top' src={farmer} autoPlay loop muted></video>
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-4 justify-center items-center text-[#50653e]">
