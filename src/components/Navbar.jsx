...
const Navbar = () => {
  return (
    <header className=" absolute w-full h-16 flex justify-between  z-19 items-center px-4 p-1">
        ...
        <Link  to={'http://spectrumms.in/erp/admin/login'} className="w-auto h-[50%] backdrop-blur-lg border-2 border-[#1b3a2a]  rounded flex gap-3 justify-center items-center p-4 cursor-pointer text-[#1b3a2a]" >
          <FaUserAlt className=" " />
